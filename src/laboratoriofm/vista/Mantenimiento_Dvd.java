...
public class Mantenimiento_Dvd extends javax.swing.JInternalFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (txtId.getText().length() != 0 && txtNombre.getText().length() != 0
                ...
                ) {
            {
                ...
                pisosInsertar.setGenero_Dvd(txtGenero.getText());
    ...
    private void btnAyudaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAyudaActionPerformed
        ...
        try {
            if ((new File("src\\laboratoriofm\\ayuda\\MantenimientoDVD.chm")).exists()) {
                Process p = Runtime
                        .getRuntime()
                        .exec("rundll32 url.dll,FileProtocolHandler src\\laboratoriofm\\ayuda\\MantenimientoDVD.chm");
                p.waitFor();
            } else {
